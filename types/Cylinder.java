...
public class Cylinder extends Solid {
	...
	public String toString() {
		return "CYLINDER, Radius: " + getRadius() + "; Height: " + getHeight() + "; Volume: " + calculateVolume() + "; Surface: " + calculateSurface();
	}

	@Override
	public double calculateVolume() {
		double result = 0.0;
		result = ((Math.pow(getRadius(), 2)) * Math.PI * getHeight());
		return result;
	}
	...
	public double calculateSurface() {
		double result = 0.0;
		result = (2.0 * Math.PI * getRadius() * (getRadius() + getHeight()));
		return result;
	}
